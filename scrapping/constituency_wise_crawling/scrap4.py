...
code = ["141", "47", "193", "177", "120", "56", "63", "78", "57", "173"]
...
with open("data/Rajasthan/Rajasthan.csv", 'w') as f:

    for i in code:
        n = str(i)
        lr = key_list[val_list.index(n)]
        page = requests.get("http://eciresults.nic.in/ConstituencywiseS20" + i + ".htm?ac=" + i)
